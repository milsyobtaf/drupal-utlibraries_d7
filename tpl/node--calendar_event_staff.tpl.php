  ...
  <div class="content content-group calendar-event calendar-event-public"<?php print $content_attributes; ?>>
    ...
    <?php
      ...
      <div class="cal-display-details"><!-- Beginning of calendar event detail display -->
        <p><?php print render($content['field_scal_event_date']); ?></p>
        ...
        <?php elseif (($content['field_scal_event_location']['#items']['0']['value'] == 'other') && (empty($content['field_scal_event_location_other']))): ?>
          <?php print render($content['field_scal_event_room']); ?>
        <?php elseif (($content['field_scal_event_location']['#items']['0']['value'] == 'other') && (($content['field_scal_event_location_other']))): ?>
            <p class="cal-display-details-location">At the<?php print render($content['field_scal_event_location_other']) . '<span class="cal-display-separator">,</span>' . render($content['field_scal_event_room']); ?>
            </p>
        <?php else: ?>
        <p class="cal-display-details-location">At the<?php print render($content['field_scal_event_location']) . '<span class="cal-display-separator">,</span>' . render($content['field_scal_event_room']); ?>
        </p>
        <?php endif; ?>

      <?php print render($content['field_scal_event_image']); ?>
      <?php print render($content['field_scal_event_description']); ?>
      ...
      <div class="cal-display-metadata">
        ...
        <?php elseif ($content['field_scal_event_location']['#items']['0']['value'] == 'other'): ?>
        <?php else: ?>
        <div class="cal-event-location-map">
          <h4>Getting to the<?php print render($content['field_scal_event_location']); ?></h4>
          <a href="http://www.google.com/maps/place/<?php print urlencode(render($content['field_scal_event_location']['0'])); ?>"target="_blank">
            <img src="http://www.utexas.edu/maps/main/buildings/graphics/insets/<?php print render($content['field_scal_event_location']['#items']['0']['value']);?>_inset.gif" />
          </a>
          <p><a href="http://www.google.com/maps/place/<?php print urlencode(render($content['field_scal_event_location']['0'])); ?>" target="_blank">Click Here To Open Map In A New Page</a></p>
        </div>
        <?php endif; ?>
