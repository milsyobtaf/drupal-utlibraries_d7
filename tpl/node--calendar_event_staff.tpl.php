    ...
    <?php
      ...
      <div class="cal-display-details"><!-- Beginning of calendar event detail display -->
        ...
        <?php elseif ($content['field_scal_event_location']['#items']['0']['value'] == 'other'): ?>
          <p class="cal-display-details-location">At the<?php print render($content['field_scal_event_location_other']) . ',' . render($content['field_scal_event_room']); ?></p>
        <?php else: ?>
          <p class="cal-display-details-location">At the<?php print render($content['field_scal_event_location']) . ',' . render($content['field_scal_event_room']); ?></p>
      <?php endif; ?>
